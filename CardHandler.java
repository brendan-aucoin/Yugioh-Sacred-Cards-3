...
public class CardHandler {
	public static HashMap<CardList,Card> allCards;
	public CardHandler() {
	...
	private void addCards() {
		...
		try {
			...
			allCards.put(CardList.OBELISK_THE_TOREMENTOR,new ObeliskTheTormentor());
		}catch(FileNotFoundException e) {
				System.out.println("file not found for creating card stats");
		}
	}
	
	public static Card getCard(CardList cardName) {
